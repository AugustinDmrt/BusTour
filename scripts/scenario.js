...
if (scenario === "1") {
  console.log("Scénario 1 sélectionné");
} else if (scenario === "2") {
  console.log("Scénario 2 sélectionné");
} else if (scenario === "3") {
  console.log("Scénario 3 sélectionné");
} else {
  console.log("Aucun scénario valide sélectionné");
}
  ...
  api.start(function () {
    api.addEventListener("viewerready", () => {
      ...
      url = getNewPastilleURL(
        ...
        512,
        256
      ); // Couleurs: intérieur, cercle, texte, texte
